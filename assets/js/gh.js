async function fetchData(ghLogin) {
    let response = await fetch(`https://ghcg.lyova24.ru/api/gh-contrib-graph/fetch-data/?login=${ghLogin}`, {method: "GET"});
...
function init_thumbnail() {
    ...
    thumbnailImage.src = "https://ghcg.lyova24.ru/static/thumbnail.png";
